...
//To connect to Vite(React)React. 5173 is Vite Port number
...
public class EmpController {
	...
	public ResponseEntity<String> addEmployee(@RequestBody Employee e) {
		//ResponseEntity<String> is used to return the String
		Employee ob=empRepository.save(e);//To save the data in the database
